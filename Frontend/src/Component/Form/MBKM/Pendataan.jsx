  ...
  const changeNumber = (e) => {
    ...
    return(
        <div className="w-full flex flex-col justify-center items-center">
            ...
            <h1 className="text-5xl font-semibold mt-6">{Judul}</h1>
            ...
            <div className="flex flex-col justify-around  items-start w-[90%]">
                <div className="w-full relative">
                    ...
                    <select className="w-full h-10  my-6 border border-gray-400 rounded-sm bg-gray-200 px-2">
                ...
                <div className="w-full relative">
                    ...
                    <select className="w-full h-10 border border-gray-400 rounded-sm bg-gray-200 px-2" onChange={(e) => {setProgram(e.target.value)}}>
                ...
                {program == 'Studip' ? 
                    <select className="w-full h-10 border border-gray-400 rounded-sm bg-gray-200 px-2 mt-6">
                ...
                null }
                <input type="text" id="Dosen" className="w-full h-10 my-6 border border-gray-400 rounded-sm bg-gray-200 px-2" placeholder="Nama Dosen Pembimbing Akademik"/>
                <input type="text" id="Intuisi" className="w-full h-10 border border-gray-400 rounded-sm bg-gray-200  px-2" placeholder="Intuisi / Mitra Kolaborasi"/>
                <input type="text" id="NamaPembimbingMBKM" className="w-full h-10 my-6 border border-gray-400 rounded-sm bg-gray-200  px-2" placeholder="Nama Pembimbing MBKM"/>
                <input type="text" id="NamaPembimbingIndustri" className="w-full h-10 border border-gray-400 rounded-sm bg-gray-200  px-2" placeholder="Nama Pembimbing Industri"/>
                <form action="/upload" method="" enctype="multipart/form-data" className="w-full my-6 flex flex-col h-[200px] justify-between">
                    ...
                    <div className="w-full  flex flex-row">
                        <label className="w-[45%] h-10  relative text-[--primary-color] italic border border-gray-400 rounded-sm bg-gray-200 flex hover:cursor-pointer items-center justify-start px-2">
                        ...
                        <input type="file" onChange={handleFile} id="SuratIzin" accept="application/pdf,application/msword, application/docx" className="w-[45%] hidden h-10 border border-gray-400 rounded-sm bg-gray-200 text-center bg-gray-200 px-2" />
                        </label>
                        {exampleFile ? 
                    ...
                    <div className="w-full  flex flex-row">
                        <label className="w-[45%] h-10 relative text-[--primary-color] italic border border-gray-400 rounded-sm bg-gray-200 flex hover:cursor-pointer items-center justify-start bg-gray-200 px-2">
                        ...
                        <input onChange={handleFile} type="file" id="Transkrip" className="w-[45%] hidden h-10 border border-gray-400 rounded-sm bg-gray-200 text-center bg-gray-200 px-2" placeholder="Upload Transkrip Nilai UMB"/>
                        </label>
                        {exampleFile ? 
                            <div><ExampleFile setClose={setExampleFile}/></div>
                                    :
                    ...
                    <div className="w-full  flex flex-row">
                        ...
                        <input onChange={handleFile} type="file" id="Silabus" className="w-[45%] hidden h-10 border border-gray-400 rounded-sm bg-gray-200 text-center bg-gray-200 px-2" placeholder="Upload Silabus MBKM"/>
                        </label>
                        {exampleFile ? 
                            <div><ExampleFile setClose={setExampleFile}/></div>
                                    :
                    ...
                    <div className="w-full  flex flex-row">
                        ...
                        <input onChange={handleFile} type="file" id="KRS" className="w-[45%] hidden h-10 border border-gray-400 rounded-sm bg-gray-200 text-center bg-gray-200 px-2" placeholder="Upload KRS Berjalan"/>
                        </label>
                        {exampleFile ? 
                            <div><ExampleFile setClose={setExampleFile}/></div>
                                    :
                ...
                <input maxLength={13} type="text" id="NoHandphone" value={number} onChange={changeNumber} className="w-full h-10 border border-gray-400 rounded-sm bg-gray-200  px-2" placeholder="No handphone"/>
            </div>
        </div>
    )
}
