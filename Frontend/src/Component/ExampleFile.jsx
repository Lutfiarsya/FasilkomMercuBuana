...
const ExampleFile = ({setClose}) => {
    return(
        ...
        <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-[--primary-color] text-white flex flex-col font-['Poppins']  font-regular rounded-md w-[600px] h-[600px] z-30 p-4">
            <img src={file}
