                ...
                <motion.div className="overflow-hidden w-full h-full items-center flex flex-col">
                    ...
                    <div className="relative flex flex-col w-full h-full items-center justify-center">
                        <input
                         ...
                         value={gmailVerify}
                        />
                        <PrimaryButton functionButton={handleVerify} text={'Verify Gmail'} width={'80%'} height={'10'} style={'text-sm mt-4 rounded-md'}/>
                        </div>
                        </motion.div>    
                    </motion.div> 
                       : codeVerify == 'codeVerify' ?
                        ...
                        <div className="flex flex-col w-full justify-center items-center">
                            ...
                            <SecondaryButton text={'Back'} functionButton={() => {fillSuccess ?  setFillSuccess(false) : setCodeVerify('verify')}}  style={'w-36 mr-6 border-2 px-4 border-[--primary-color]'}/>
                            <PrimaryButton text={fillSuccess ? 'Submit' : 'Next'} functionButton={() =>  setFillSuccess(true)} style={'rounded-md mr-7 px-4 w-36'}  height={'10'}/>
                            </div>
                        </div>
                    }
                </div>
