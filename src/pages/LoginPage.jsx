           ...
           <div className="flex flex-col w-[50%] my-20  items-center">
              ...
              <div className="mt-16 flex flex-col h-[60%] justify-around relative">
                <div className="relative">
                    ...
                    <input value={username} onChange={(e) => setUsername(e.target.value)} placeholder="NIM" className="w-[400px] h-10 px-10 rounded-md placeholder-italic text-md font-['Poppins'] shadow-[4px_4px_8px_-4px_black]"/>
                </div>
                <div className="relative">
                    <Lock size={21} className="absolute top-[9px] left-3"/>
                    <input value={password} placeholder="Password" type="password" onChange={(e) => setPassword(e.target.value)}  className="w-[400px] h-10 px-10 rounded-md italic text-md font-['Poppins'] shadow-[4px_4px_8px_-4px_black]" />
                </div>
